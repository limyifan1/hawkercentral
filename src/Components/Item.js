        ...
        {this.props.name !== undefined ? (
          ...
          >
            ...
            {this.props.claps !== undefined ? (
              ...
              >
                <span
                  class="badge badge-danger d-flex justify-content-start align-items-center"
                  style={{
                ...
                >
                  ...
                  <span style={{ color: "black", paddingLeft:"5px" }}> {+this.props.claps}</span>
                </span>
              </div>
            ) : null}
            ...
            <figcaption>
              <div class="card-body" style={{ width: "100%", height: "100%" }}>
                {this.props.name ? (
                  ...
                  <h6 class="card-title">Sample Stall Name</h6>
                )}
